        ...
        Column(
            ...
            ListItem(
                ...
                trailingContent = {
                    ...
                    Box {
                        IconButton(onClick = {
                            if (state.isHapticsEnabled) haptic.performHapticFeedback(
                        ...
                        onCheckedChange = { isEnabling ->
                            ...
                            if (isEnabling && biometricAuthenticator.isBiometricAvailable()) {
                                biometricAuthenticator.authenticate(
                                    ...
                                    onSuccess = {
                                        viewModel.handleIntent(
                                            SettingsContract.Intent.SetBiometricEnabled(
                                                true
                                            )
                                        )
                                    },
            ...
            ListItem(
                ...
                modifier = Modifier.clickable {
                    if (state.isHapticsEnabled) haptic.performHapticFeedback(HapticFeedbackType.LongPress)
                    budgetInput =
                        if (state.monthlyBudget > 0) state.monthlyBudget.toInt().toString() else ""
            ...
            ListItem(
                ...
                modifier = Modifier.clickable {
                    if (state.isHapticsEnabled) haptic.performHapticFeedback(HapticFeedbackType.LongPress)
                    csvExportLauncher.launch("Tralance_Report_${System.currentTimeMillis()}.csv")
                },
                trailingContent = {
            ...
            ListItem(
                ...
                modifier = Modifier.clickable {
                    if (state.isHapticsEnabled) haptic.performHapticFeedback(HapticFeedbackType.LongPress)
                    exportLauncher.launch("Tralance_Backup_${System.currentTimeMillis()}.tralance")
                },
                trailingContent = {
                    ...
                    onClick = {
                        ...
                        if (uri != null && backupPassword.isNotBlank()) {
                            if (showBackupPasswordDialog == BackupAction.EXPORT) {
                                viewModel.handleIntent(
                                    SettingsContract.Intent.ExportData(
                                        uri,
                                ...
                                viewModel.handleIntent(
                                    SettingsContract.Intent.ImportData(
                                        uri,
                                        backupPassword.toCharArray()
                                    )
                                )
                        ...
                        Row(
                            modifier = Modifier
                                ...
                                .clickable {
                                    ...
                                    viewModel.handleIntent(
                                        SettingsContract.Intent.SetAutoLockTimeout(
                                            value
                                        )
                                    )
