package com.abrarshakhi.denapawna.sms

import com.abrarshakhi.denapawna.domain.model.ParsedTransaction
...
class SmsParser @Inject constructor() {
    ...
    private val accountExclusionPattern =
        Pattern.compile("(?i)(?:a/c|acc|account|ending|no|id|ref)\\s*(?:no\\.?)?\\s*[:#-]?\\s*\\d+")
