...
class BackupRepository @Inject constructor(
    ...
    suspend fun exportData(outputStream: OutputStream, password: CharArray): Result<Unit> =
    ...
    suspend fun importData(inputStream: InputStream, password: CharArray): Result<Unit> =
        withContext(Dispatchers.IO) {
            try {
